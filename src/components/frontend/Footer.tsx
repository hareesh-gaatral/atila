    ...
    <footer className="bg-navy dark:bg-[#020617] text-white transition-colors duration-500">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2">
            <div className="mb-5">
              <img src={content.logo} alt={content.logoAlt} className="h-10 w-auto" />
            </div>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-semibold text-white mb-5 text-sm uppercase tracking-wider">{content.quickLinksTitle}</h4>
            <ul className="space-y-3">
              {content.quickLinks.map((link: { href: string; label: string }) => (
                <li key={link.href + link.label}>
                  <Link href={link.href} className="text-slate-300 hover:text-teal-400 dark:text-slate-400 dark:hover:text-teal-400 transition text-sm">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          {/* Contact */}
          <div>
            <h4 className="font-semibold text-white mb-5 text-sm uppercase tracking-wider">{content.contactTitle}</h4>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-slate-400 dark:text-slate-500">
