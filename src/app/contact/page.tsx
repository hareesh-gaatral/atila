        ...
        <section className="pt-24 pb-12 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-[#0f172a] dark:via-[#1e293b] dark:to-[#0f172a] transition-colors duration-500">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
              Our procurement experts are ready to help you transform your purchasing workflows.
            </p>
          </div>
        </section>

        {/* Contact Content */}
        <section id="contact" className="py-16 bg-white dark:bg-[#0f172a] transition-colors duration-500">
